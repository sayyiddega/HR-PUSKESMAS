...
public class AppSettingService {
    ...
    public AppSetting update(AppSettingRequest req) {
        ...
        if (req.landingHeroBadge() != null) s.setLandingHeroBadge(req.landingHeroBadge());
        if (req.landingHeroTitle() != null) s.setLandingHeroTitle(req.landingHeroTitle());
        if (req.landingHeroSubtitle() != null) s.setLandingHeroSubtitle(req.landingHeroSubtitle());
        if (req.landingStatusText() != null) s.setLandingStatusText(req.landingStatusText());
        if (req.landingVisionText() != null) s.setLandingVisionText(req.landingVisionText());
        if (req.landingMission1() != null) s.setLandingMission1(req.landingMission1());
        if (req.landingMission2() != null) s.setLandingMission2(req.landingMission2());
        if (req.landingMission3() != null) s.setLandingMission3(req.landingMission3());
        if (req.landingFooterText() != null) s.setLandingFooterText(req.landingFooterText());
