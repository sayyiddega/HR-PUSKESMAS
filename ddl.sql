...
-- Delta: Enriched biodata fields for ASN-style profile
ALTER TABLE hr_puskesmas.employees ADD COLUMN IF NOT EXISTS nip VARCHAR(30);
ALTER TABLE hr_puskesmas.employees ADD COLUMN IF NOT EXISTS nik VARCHAR(30);
ALTER TABLE hr_puskesmas.employees ADD COLUMN IF NOT EXISTS gender VARCHAR(10);
ALTER TABLE hr_puskesmas.employees ADD COLUMN IF NOT EXISTS place_of_birth VARCHAR(100);
ALTER TABLE hr_puskesmas.employees ADD COLUMN IF NOT EXISTS marital_status VARCHAR(30);
ALTER TABLE hr_puskesmas.employees ADD COLUMN IF NOT EXISTS religion VARCHAR(30);
ALTER TABLE hr_puskesmas.employees ADD COLUMN IF NOT EXISTS last_education VARCHAR(100);
ALTER TABLE hr_puskesmas.employees ADD COLUMN IF NOT EXISTS rank_golongan VARCHAR(30);
ALTER TABLE hr_puskesmas.employees ADD COLUMN IF NOT EXISTS employment_status VARCHAR(30);
...
-- Delta: Landing page configurable texts
ALTER TABLE hr_puskesmas.app_settings ADD COLUMN IF NOT EXISTS landing_hero_badge VARCHAR(200);
ALTER TABLE hr_puskesmas.app_settings ADD COLUMN IF NOT EXISTS landing_hero_title VARCHAR(300);
ALTER TABLE hr_puskesmas.app_settings ADD COLUMN IF NOT EXISTS landing_hero_subtitle VARCHAR(1000);
ALTER TABLE hr_puskesmas.app_settings ADD COLUMN IF NOT EXISTS landing_status_text VARCHAR(300);
ALTER TABLE hr_puskesmas.app_settings ADD COLUMN IF NOT EXISTS landing_vision_text VARCHAR(1000);
ALTER TABLE hr_puskesmas.app_settings ADD COLUMN IF NOT EXISTS landing_mission1 VARCHAR(300);
ALTER TABLE hr_puskesmas.app_settings ADD COLUMN IF NOT EXISTS landing_mission2 VARCHAR(300);
