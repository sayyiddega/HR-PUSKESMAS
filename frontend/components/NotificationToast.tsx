...
const NotificationToast: React.FC<Props> = ({ content, onClose }) => {
  ...
  return (
    <div className="fixed bottom-4 right-4 z-[200] w-72 bg-white rounded-2xl shadow-lg border-l-4 border-teal-500 overflow-hidden animate-in slide-in-from-right duration-300">
      <div className="p-4">
